...
## Problem Statement
E-commerce companies often deal with **large volumes of sales data** across multiple products, regions, and time periods.  

The challenge is to:  
- Understand **overall sales performance**  
- Identify **top-selling products and regions**  
- Detect **monthly and seasonal revenue trends**  
- Determine **customer payment preferences**  
- Provide **interactive dashboards** for stakeholders without manual query execution  
...
2. Use slicers to filter by **Date, Region, or Product Category**  
